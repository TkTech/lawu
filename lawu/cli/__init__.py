...
from lawu import instructions, attribute
...
def what_command(topic):
    ...
    if ins:
        console.print(f"[magenta]{topic}[/] is a [magenta]JVM instruction.[/]")
        ...
        if ins.fmt:
            ...
            segments = list(
                itertools.chain.from_iterable(
                    structify(fmt, labels=(instructions.OperandTypes(of_type).name,))
    ...
    if attr:
        console.print(f"[magenta]{topic}[/] is a [magenta]JVM attribute.[/]")
