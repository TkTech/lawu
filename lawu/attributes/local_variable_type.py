...
local_variable_type_entry = namedtuple(
    "local_variable_type_entry",
...
class LocalVariableTypeTableAttribute(Attribute):
    ...
    def __init__(self, table, name_index=None):
        super().__init__(
            table,
            name_index
            or table.cf.constants.create_utf8("LocalVariableTypeTable").index,
        )
    ...
    def unpack(self, info):
        ...
        self.local_variables = [
            local_variable_type_entry(*x) for x in zip(*[iter(table)] * 5)
        ]
