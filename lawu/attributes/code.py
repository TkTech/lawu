...
class CodeAttribute(Attribute):
    ...
    .. code-block:: python
        ...
        main = cf.methods.create(
            ...
            '([Ljava/lang/String;)V',
            # Tell Lawu to automatically create an empty CodeAttribute for
            # us to use.
            code=True
        )
    ...
    def assemble(self, code):
        """
        Assembles an iterable of :class:`~lawu.util.bytecode.Instruction`
    ...
    def disassemble(self, *, transforms=None) -> Iterator[Instruction]:
        ...
        :class:`~lawu.util.bytecode.Instruction` objects.
        """
