...
from lawu.cf import ClassVersion, ClassFile
from lawu.attribute import get_attribute_classes
from lawu.util import bytecode, shell
...
def definition_to_json(source):
    ...
    Lawu internally uses a YAML file to define all bytecode opcodes, operands,
